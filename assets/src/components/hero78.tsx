...
const Hero78 = () => {
  return (
    <section className="dark relative flex h-svh max-h-[1400px] w-svw overflow-hidden bg-[url(/images/block/full-width-backgrounds/pawel-czerwinski-IbHFznCKnqA-unsplash.jpg)] bg-cover bg-center bg-no-repeat font-sans after:absolute after:top-0 after:left-0 after:z-10 after:h-full after:w-full after:bg-black/20 after:content-[''] md:h-svh">
